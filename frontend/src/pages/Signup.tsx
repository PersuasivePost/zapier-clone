    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-orange-400 to-pink-500 items-center justify-center p-12">
        <div className="text-white text-center max-w-md">
          <h2 className="text-4xl font-bold mb-4">Start automating today</h2>
          <p className="text-lg opacity-90 mb-12">
            Join millions who use Zapier to connect their apps and automate
          ...
          <div className="space-y-6 text-left">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold">6,000+ integrations</p>
                <p className="text-sm opacity-90">Connect your favorite apps</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 bg-white rounded-full flex items-center justify-center flex-shrink-0 mt-1">
              ...
              <div>
                ...
                <p className="text-sm opacity-90">Over 2M+ active users</p>
              </div>
            </div>
          </div>
        </div>
